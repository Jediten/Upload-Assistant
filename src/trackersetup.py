...
from src.trackers.TAV import TAV
...
tracker_class_map: dict[str, type[Any]] = {
    ...
    'TAV': TAV, 'TIK': TIK, 'TL': TL, 'TLZ': TLZ, 'TOS': TOS, 'TVC': TVC, 'TTG': TTG, 'TTR': TTR, 'ULCX': ULCX, 'UTP': UTP, 'VMF': VMF, 'MNS': MNS, 'NQ': NQ, 'YOINK': YOINK, 'YUS': YUS, 'ZNTH': ZNTH
}

api_trackers = {
    'A4K', 'ACM', 'AITHER', 'BHD', 'BLU', 'CBR', 'DP', 'DT', 'EMUW', 'FRIKI', 'HHD', 'HUNO', 'IHD', 'ITT', 'LCD', 'LDU', 'LST', 'LT', 'LUME',
    'OE', 'OTW', 'PT', 'PTT', 'RAS', 'RF', 'R4E', 'SAM', 'SHRI', 'SP', 'STC', 'TAV', 'TIK', 'TLZ', 'TOS', 'TTR', 'NQ', 'ULCX', 'UTP', 'VMF', 'MNS', 'YOINK', 'YUS', 'ZNTH'
}
