...
async def merge_meta(meta: Meta, saved_meta: Meta) -> dict[str, Any]:
    ...
    overwrite_list = [
        ...
        'hdb', 'ptp', 'blu', 'no_season', 'no_aka', 'no_year', 'force_year', 'no_dub', 'no_tag', 'no_seed', 'client', 'description_link', 'description_file', 'desc', 'draft',
...
async def process_meta(meta: Meta, base_dir: str, bot: Any = None) -> None:
    ...
    if not meta['trackers']:
        ...
        for tracker in ["AITHER", "ASC", "BJS", "BT", "CBR", "DP", "FF", "GPW", "HUNO", "IHD", "LDU", "LT", "MNS", "OE", "PTS", "SAM", "SHRI", "SPD", "TTR", "TVC", "ULCX", "VMF"]:
